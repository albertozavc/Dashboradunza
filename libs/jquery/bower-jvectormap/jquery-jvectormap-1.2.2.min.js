...
jvm.$ = jQuery, jvm.AbstractElement = function(e, t) {
    ...
    zoomMin: 1,
    zoomStep: 1.6,
    initialZoom: 5, // Ajusta el zoom inicial a un valor más apropiado para ver México
    initialCenter: { // Añadir la propiedad para centrar el mapa
        lat: 23.6345, // Latitud de México
        lng: -102.5528 // Longitud de México
    },
    regionsSelectable: !1,
    markersSelectable: !1,
    bindTouchEvents: !0,
